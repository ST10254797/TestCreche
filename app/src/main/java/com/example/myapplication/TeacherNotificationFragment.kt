...
class TeacherNotificationFragment : Fragment() {
    ...
    private fun fetchNotifications() {
        ...
        val maxAgeMillis = 14 * 24 * 60 * 60 * 1000L // 2 weeks, optional filter
        ...
        firestore.collection("Events")
            ...
            .addOnSuccessListener { eventResult ->
                for (doc in eventResult) {
                    ...
                    val eventDate = doc.id // This is the actual event date (document ID)
                    ...
                    if (System.currentTimeMillis() - ts <= 14 * 24 * 60 * 60 * 1000L) { // Only recent events
                        ...
                        notificationsList.add(
                            NotificationItem(
                                title = "Reminder!",
                                subtitle = "$eventText\nEvent Date: $eventDate", // Added event date
                                date = createdAt,
